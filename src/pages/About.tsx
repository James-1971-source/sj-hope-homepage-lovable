...
const history = [
  { year: "2015", event: "사단법인 S&J희망나눔 설립" },
  { year: "2016", event: "청소년 학습지원 프로그램 시작" },
  { year: "2017", event: "OO구청 청소년복지사업 위탁 운영" },
  { year: "2018", event: "문화예술 체험활동 프로그램 확대" },
  { year: "2019", event: "청소년 멘토링 사업 시작" },
  { year: "2020", event: "비대면 교육 프로그램 도입" },
  { year: "2021", event: "자원봉사자 300명 돌파" },
  { year: "2022", event: "청소년 상담센터 개소" },
  { year: "2023", event: "누적 수혜 청소년 5,000명 달성" },
  { year: "2024", event: "시설 확장 및 프로그램 다양화" },
];
        ...
        <div className="container-wide">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              ...
              <p className="mt-8 text-right text-foreground font-semibold">
                사단법인 S&J희망나눔 이사장 OOO
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card-warm p-8 text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {["학습지원팀", "상담복지팀", "문화사업팀", "운영지원팀"].map((team) => (
                  <div key={team} className="bg-muted px-4 py-3 rounded-xl font-medium text-foreground">
                    {team}
                  </div>
                ))}
              </div>
